...
public partial class TerrainBaking : Node
{
    ...
    public void RebakeRemoveBuilding(Building building)
    {
        if (!CurrentlyBaking)
        {
            StaticBody2D obstacle = CurrentRegion.GetNode<StaticBody2D>("Obstacle_Region_" + building.Data.BuildingType+ "_" + building.SelfIndex);
    ...
    {
        building.StaticBody.Name = "Obstacle_Region_Type_" + building.Data.BuildingType + "_Index_" + building.SelfIndex;
